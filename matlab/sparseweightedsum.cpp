 ...
 * == windows ==
 * 
 * mex OPTIMFLAGS="/O2" -largeArrayDims -lmwblas -DNUM_THREADS=4 sparseweightedsum.cpp
 * 
 * == linux ==
 * 
 * mex OPTIMFLAGS="-O3" -largeArrayDims -lmwblas -DNUM_THREADS=4 -v CXXFLAGS='$CXXFLAGS -std=c++0x -fPIC' sparseweightedsum.cpp
 */
